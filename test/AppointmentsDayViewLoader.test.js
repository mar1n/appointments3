...
import { responseOkOf } from './spyHelpers';
...
describe('AppointmentsDayViewLoader', () => {
    ...
    beforeEach(() => {
        ...
        jest.spyOn(window, 'fetch').mockReturnValue(responseOkOf(appointments));
    ...
    it('fetches appointments happing today when component is mounted', async () => {
    ...
    it('display time slots that are fetched on mount', async () => {
        await renderAndWait(<AppointmentsDayViewLoader />);
        expect(
            AppointmentsDayViewExports.AppointmentsDayView
