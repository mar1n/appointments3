...
import {  click, className, child,  createShallowRenderer,  type, id, childrenOf} from './shallowHelpers';
...
describe('App', () => {
    ...
    it('has button to initiate add customer add appointment action', () => {
        render(<App />);
    ...
    const beginAddingCustomerAndAppointment = () => {
      ...
      it('hides the button bar when CustomerForm is being displayd', async () => {
          beginAddingCustomerAndAppointment();
